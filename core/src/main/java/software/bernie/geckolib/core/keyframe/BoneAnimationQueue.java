 ...
 */
public final class BoneAnimationQueue {
    ...
    public BoneAnimationQueue(CoreGeoBone bone, AnimationPointQueue rotationXQueue, AnimationPointQueue rotationYQueue,
    ...
    public boolean equals(Object obj) {
        ...
        BoneAnimationQueue that = (BoneAnimationQueue) obj;
        return Objects.equals(this.bone, that.bone) &&
                Objects.equals(this.rotationXQueue, that.rotationXQueue) &&
                Objects.equals(this.rotationYQueue, that.rotationYQueue) &&
                Objects.equals(this.rotationZQueue, that.rotationZQueue) &&
                Objects.equals(this.positionXQueue, that.positionXQueue) &&
                Objects.equals(this.positionYQueue, that.positionYQueue) &&
                Objects.equals(this.positionZQueue, that.positionZQueue) &&
                Objects.equals(this.scaleXQueue, that.scaleXQueue) &&
                Objects.equals(this.scaleYQueue, that.scaleYQueue) &&
                Objects.equals(this.scaleZQueue, that.scaleZQueue);
    }

    @Override
    public int hashCode() {
        return Objects.hash(bone, rotationXQueue, rotationYQueue, rotationZQueue, positionXQueue, positionYQueue, positionZQueue, scaleXQueue, scaleYQueue, scaleZQueue);
    }
    ...
    public String toString() {
        return "BoneAnimationQueue[" +
                "bone=" + bone + ", " +
                "rotationXQueue=" + rotationXQueue + ", " +
                "rotationYQueue=" + rotationYQueue + ", " +
                "rotationZQueue=" + rotationZQueue + ", " +
                "positionXQueue=" + positionXQueue + ", " +
                "positionYQueue=" + positionYQueue + ", " +
                "positionZQueue=" + positionZQueue + ", " +
                "scaleXQueue=" + scaleXQueue + ", " +
                "scaleYQueue=" + scaleYQueue + ", " +
                "scaleZQueue=" + scaleZQueue + ']';
    }
